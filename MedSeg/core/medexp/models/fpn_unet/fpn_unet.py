...
class UNET3DwithAttention(pl.LightningModule):
    ...
    def __init__(
        ...
        super().__init__()
        # Layers
        self._fpn = FPN_BackBone_3D(
            in_channels=in_channels
        )  # [256, 12, 12, 12][128, 24, 24, 24][64, 48, 48, 48]
        ...
        self.scaling_val = 1 / 15  # Arbitrary scaling factor
    ...
    def forward(self, x):
        ...
        attn_mp = [torch.sigmoid(t) / self.scaling_val for t in self._fpn(noise)]
